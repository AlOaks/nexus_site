...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$nexus_theme_scratch_description = get_bloginfo( 'description', 'display' );
			if ( $nexus_theme_scratch_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $nexus_theme_scratch_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
