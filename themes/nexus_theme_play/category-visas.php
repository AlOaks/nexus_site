	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<section class="blog-body">
				...
				<div class="blog-categories-dropdown">Immigration <i class="fas fa-chevron-down"></i><i class="fas fa-chevron-up"></i></div>
				...
				<section class="blog-section">
						<?php		
                        $args = array('posts_per_page'=>-1, 'category_name'=>'visas');
