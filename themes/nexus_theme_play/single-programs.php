	...
	<div id="primary" class="content-area">
		...
		?>
				...
				<section class="program-hero">
					...
					<ul class="program-info">
						<li class="program-info-item">
							<p class="li-title">Price</p>
							<p class="li-field"><?php echo $price; ?></p>
						</li>
						<li class="program-info-item">
							<p class="li-title">Duration</p>
							<p class="li-field"><?php echo $duration; ?></p>
						</li>
						<li class="program-info-item">
							<p class="li-title">City</p>
							<p class="li-field"><?php echo $city; ?></p>
						</li>
						<li class="program-info-item">
							<p class="li-title">Hrs / Week</p>
				...
				<section class="about-container program-container">
					...
					<div class="about-program">
						<div class="program-description">
							<p class="about-program-title">About Program</p>
							<?php the_content(); ?>
						</div>
						<?php the_post_thumbnail(); ?>
					</div>
					
					<a class="program-apply-btn">Apply Now</a>
				</section>
				...
				<section class="about-container school-container">
					...
					<a class="explore-more">Explore Other Programs</a>
				</section>
				...
				<section class="student-review">
					<p class="review-title">Student Review</p>
					<div class="review-container-program">
						...
						<p class="review-paragraph">
							...
							When I started the UX Professional Program I appreciated that it wasn’t all lecture-style teaching, and involved a lot of interactive learning. 
							Also, the projects were with real businesses.
