			...
			<div id="primary" class="content-area">
                ...
                <?php while(have_posts()): the_post(); ?>
                    ...
                    <section class="areas-section-carnaval">
                        <div class="area-landing-carnaval esl-carnaval" style="no-repeat center background: url(<?php echo CFS()->get('esl_bkg')?>);">
                        ...
                        <div class="area-landing-carnaval ws-carnaval" style="no-repeat center background: url(<?php echo CFS()->get('ws_bkg'); ?>);">
                            <h3><?php _e('Work & Study', 'Landing Pages'); ?></h3>
                            <p><?php echo CFS()->get('ws_lp_description'); ?></p>
                            <a href="#contact-form-carnaval"><?php _e('Learn More', 'Landing Pages'); ?></a>
                        </div>
                        <div class="area-landing-carnaval he-carnaval" style="no-repeat center background: url(<?php echo CFS()->get('he_bkg'); ?>);">
